...
// in this case is the main Tfvet process.
type GRPCClient struct{ client proto.TfvetRulePluginClient }
...
func (p *TfvetRulePlugin) GRPCClient(ctx context.Context, broker *plugin.GRPCBroker, c *grpc.ClientConn) (interface{}, error) {
	return &GRPCClient{client: proto.NewTfvetRulePluginClient(c)}, nil
}
